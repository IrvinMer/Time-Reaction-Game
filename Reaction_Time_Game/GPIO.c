 ...
 *
 * Additional functionality includes PWM control for the red LED and direct GPIO
 * Control for the green LED on Port E (pin 5).
 *
 * @author Irvin 
 */
...
void TURN_RED_LED_ON(void){
  // Enable PWM PE4 for red LED control
  PWM0->ENABLE |= 0x10;
