...
/**
 * @brief The TURN_RED_LED_ON function enables PWM control for the red LED and turns off PE5 LED. 
 * This function enables PWM channel 4 for controlling the red LED by setting bit 4 in the PWM0 ENABLE register.
 * It also turns off the LED connected to pin PE5 by clearing bit 5 in the GPIOE DATA register.
 * 
 * @param None
 * 
 * @return None
...
/**
 * @brief The TURN_GREEN_LED_ON function turns on the green LED.
 * This function first disables PWM channel 4
 * enables pin 5 on Port E to turn on the green LED connected to this pin.
 * 
 * @param None
 * 
 * @return None
